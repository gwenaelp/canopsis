...
class TimeSerie(object):
    ...
    def __init__(self, max_points=MAX_POINTS, period=None, sliding_time=True, operation=MEAN, fill=False, forecast=None):
...
class Forecast(object):
    ...
    def __init__(self, timeserie, max_points=MAX_POINTS, date=None, duration=None, parameters=NotLinearMidVariable, threshold=Threshold()):
...
def holtwinters(y, alpha=Forecast.ALPHA, beta=Forecast.BETA, gamma=Forecast.GAMMA, c=sys.maxint, forecast=True):
    """
    y - time series data.
